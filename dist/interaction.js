...
var Interaction = /** @class */ (function () {
    function Interaction(interaction, options) {
        var channel = options.channel, guild = options.guild, client = options.client, member = options.member;
    ...
    Interaction.prototype.reply = function (res, options) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        // @ts-ignore
                        data.type = type;
                        return [2 /*return*/, this.client.api.webhooks(this.interaction.id, this.interaction.token).callback
    ...
    Interaction.prototype.edit = function (content, options) {
        return __awaiter(this, void 0, void 0, function () {
            var data, _a, type;
            var _this = this;
            return __generator(this, function (_b) {
                ...
                // @ts-ignore
                data.type = type;
                return [2 /*return*/, this.client.api.webhooks(this.client.user.id, this.token).messages('@original')
                        .patch({ data: data })
                        .then(function (m) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, callback_1.default(this, m)];
